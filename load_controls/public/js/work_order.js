...
frappe.ui.form.on("Work Order", {
    refresh: function (frm) {
        cur_frm.add_custom_button(__('Custom Create Pick List'), function() {
           erpnext.work_order_custom.create_pick_list(frm);
        });
    }
})

erpnext.work_order_custom = {
	...
	create_pick_list: function(frm, purpose='Material Transfer for Manufacture') {
		this.show_prompt_for_qty_input(frm, purpose)
			.then(data => {
				return frappe.xcall('load_controls.doc_events.work_order.create_pick_list', {
