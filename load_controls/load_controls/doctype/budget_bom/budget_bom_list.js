frappe.listview_settings['Budget BOM'] = {
	...
	get_indicator: function (doc) {
		if (["To Quotation","Approved and To Sales Order",
				...
				"To Supplier Quotation", "To Purchase Order","To Purchase Receipt",
				"To Purchase Invoice", "To Deliver", "To Bill", "To Request for Quotation"].includes(doc.status)) {
			// Closed
		...
		} else if (["Quotation In Progress", "To SO", "To PO", "To Material Request",
				"To DN and PO","To DN and PR","To SI and PR",
