frappe.listview_settings['Budget BOM'] = {
	...
	get_indicator: function (doc) {
		if (["To Quotation","Approved and To Sales Order","To Sales Order", "Declined and To Sales Order", "Waiting for Review","To Material Request and To Work Order", "Waiting for Accept / Decline"].includes(doc.status)) {
			// Closed
